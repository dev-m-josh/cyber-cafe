  ...
  return (
    <div className="min-h-screen bg-[#0a0e14] px-6 py-24 text-white sm:px-10 lg:px-16">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4 fade-up">
          {contactDetails.map((detail) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-2 wrap-break-words font-medium text-cyan-400">
                  {detail.value}
                </p>
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/3 p-7 fade-up">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-cyan-400/20 bg-cyan-400/6 p-7 fade-up">
